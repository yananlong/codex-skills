...
ACTIVE_WORK_STATUSES = {"ready", "running", "verification", "paused"}
D3_FIELDS = {"main_question", "central_object_or_phenomenon", "contribution_class", "primary_evidence_obligation"}
