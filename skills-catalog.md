...
| documents | `adversarial-doc-review` | review | literature-review, paper-review | `documents/adversarial-doc-review` |
...
| research | `research-paper-plan` | planning | paper-planning, paper-review, research-planning, stage-routing | `research/research-paper-plan` |
| research | `research-paper-review` | review | multi-agent, paper-review | `research/research-paper-review` |
| research | `research-pipeline-planner` | orchestration | ideation, literature-review, novelty-review, paper-review, research-planning, stage-routing, ... | `research/research-pipeline-planner` |
...
| research | `research-systematic-literature-review` | review | literature-review, validation | `research/research-systematic-literature-review` |
